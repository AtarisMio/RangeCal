...
describe('Range', () => {
    ...
    describe('setter', () => {
        ...
        it('set tail = 3, in range [0, 2]', () => {
            const r = new Range(0, 2);
            assert.doesNotThrow(() => r.tail = 3);
            assert(r.tail === 3);
        });
        it('set tail = 1, in range [0, 2]', () => {
            const r = new Range(0, 2);
            assert.doesNotThrow(() => r.tail = 1);
            assert(r.tail === 1);
        });
        it('set tail = 0, in range [0, 2]', () => {
            const r = new Range(0, 2);
    ...
    describe('compare', () => {
        ...
        it('[compare] range [0, 3] and range [-3, -1], should get TOTAL_BEFORE', () => {
            assert(new Range(0, 3).compare(new Range(-3, -1)) === RandR.TOTAL_BEFORE);
        });
        it('[compare] range [0, 3] and range [-3, 1], should get HEAD_BEFORE', () => {
            assert(new Range(0, 3).compare(new Range(-3, 1)) === RandR.HEAD_BEFORE);
        });
        it('[compare] range [0, 3] and range [1, 2], should get INNER', () => {
            assert(new Range(0, 3).compare(new Range(1, 2)) === RandR.INNER);
        });
        it('[compare] range [0, 3] and range [-1, 4], should get CONTAIN', () => {
            assert(new Range(0, 3).compare(new Range(-1, 4)) === RandR.CONTAIN);
        });
        it('[compare] range [0, 3] and range [1, 4], should get TAIL_AFTER', () => {
            assert(new Range(0, 3).compare(new Range(1, 4)) === RandR.TAIL_AFTER);
        });
        it('[compare] range [0, 3] and range [4, 6], should get TOTAL_AFTER', () => {
            assert(new Range(0, 3).compare(new Range(4, 6)) === RandR.TOTAL_AFTER);
        });
        ...
        it('[compareWithRange] range [0, 3] and range [-3, -1], should get TOTAL_BEFORE', () => {
            assert(new Range(0, 3).compareWithRange(new Range(-3, -1)) === RandR.TOTAL_BEFORE);
        });
        it('[compareWithRange] range [0, 3] and range [-3, 1], should get HEAD_BEFORE', () => {
            assert(new Range(0, 3).compareWithRange(new Range(-3, 1)) === RandR.HEAD_BEFORE);
        });
        it('[compareWithRange] range [0, 3] and range [1, 2], should get INNER', () => {
            assert(new Range(0, 3).compareWithRange(new Range(1, 2)) === RandR.INNER);
        });
        it('[compareWithRange] range [0, 3] and range [-1, 4], should get CONTAIN', () => {
            assert(new Range(0, 3).compareWithRange(new Range(-1, 4)) === RandR.CONTAIN);
        });
        it('[compareWithRange] range [0, 3] and range [1, 4], should get TAIL_AFTER', () => {
            assert(new Range(0, 3).compareWithRange(new Range(1, 4)) === RandR.TAIL_AFTER);
        });
        it('[compareWithRange] range [0, 3] and range [4, 6], should get TOTAL_AFTER', () => {
            assert(new Range(0, 3).compareWithRange(new Range(4, 6)) === RandR.TOTAL_AFTER);
        });
        it('[compareWithRange] range [0, 3] and range [4, 6], should get TOTAL_AFTER', () => {
    ...
    describe('add', () => {
        it('[add] range [0, 2] add range [4, 5], should get range [[0, 2], [4, 5]]', () => {
            const r = new Range(0, 2);
            let re;
            assert.doesNotThrow(() => re = r.addRange(new Range(4, 5)));
            assert(re[0].head === 0);
            assert(re[0].tail === 2);
            assert(re[1].head === 4);
            assert(re[1].tail === 5);
        ...
        it('[add] range [0, 2] add range [3, 5], should get range [[0, 5]]', () => {
            const r = new Range(0, 2);
            let re;
            assert.doesNotThrow(() => re = r.addRange(new Range(3, 5)));
            assert(re[0].head === 0);
            assert(re[0].tail === 5);
        });
        it('[add] range [0, 2] add range [2, 5], should get range [[0, 5]]', () => {
            const r = new Range(0, 2);
            let re;
            assert.doesNotThrow(() => re = r.addRange(new Range(2, 5)));
            assert(re[0].head === 0);
            assert(re[0].tail === 5);
        });
        it('[add] range [0, 2] add range [1, 5], should get range [[0, 5]]', () => {
            const r = new Range(0, 2);
            let re;
            assert.doesNotThrow(() => re = r.addRange(new Range(1, 5)));
            assert(re[0].head === 0);
            assert(re[0].tail === 5);
        });
        it('[add] range [4, 5] add range [0, 2], should get range [[0, 2], [4, 5]]', () => {
            ...
            let re;
            assert.doesNotThrow(() => re = r.addRange(new Range(0, 2)));
            assert(re[0].head === 0);
            assert(re[0].tail === 2);
            assert(re[1].head === 4);
            assert(re[1].tail === 5);
        ...
        it('[add] range [4, 5] add range [0, 4], should get range [[0, 5]]', () => {
            const r = new Range(4, 5);
            let re;
            assert.doesNotThrow(() => re = r.addRange(new Range(0, 4)));
            assert(re[0].head === 0);
            assert(re[0].tail === 5);
        });
        it('[add] range [0, 2] add range [0, 1], should get range [[0, 2]]', () => {
            const r = new Range(0, 2);
            let re;
            assert.doesNotThrow(() => re = r.addRange(new Range(0, 1)));
            assert(re[0].head === 0);
            assert(re[0].tail === 2);
        });
        it('[add] range [0, 1] add range [-1, 2], should get range [[-1, 2]]', () => {
            const r = new Range(0, 1);
            let re;
            assert.doesNotThrow(() => re = r.addRange(new Range(-1, 2)));
            assert(re[0].head === -1);
            assert(re[0].tail === 2);
        });
    });
    describe('sub', () => {
        it('[sub] range [0, 2] sub range [4, 5], should get range [[0, 2]]', () => {
            const r = new Range(0, 2);
            let re;
            assert.doesNotThrow(() => re = r.subRange(new Range(4, 5)));
            assert(re[0].head === 0);
            assert(re[0].tail === 2);
        });
        it('[sub] range [0, 2] sub range [-2, -1], should get range [[0, 2]]', () => {
            const r = new Range(0, 2);
            let re;
            assert.doesNotThrow(() => re = r.subRange(new Range(-2, -1)));
            assert(re[0].head === 0);
            assert(re[0].tail === 2);
        });
        ...
        it('[sub] range [0, 3] sub range [0, 1], should get range [[2, 3]]', () => {
            const r = new Range(0, 3);
            let re;
            assert.doesNotThrow(() => re = r.subRange(new Range(0, 1)));
            assert(re[0].head === 2);
            assert(re[0].tail === 3);
        });
        it('[sub] range [0, 1] sub range [-1, 3], should get range [', () => {
            const r = new Range(0, 1);
            let re;
            assert.doesNotThrow(() => re = r.subRange(new Range(-1, 3)));
            assert(re.length === 0);
        });
        it('[sub] range [0, 3] sub range [0, 3], should get range []', () => {
            const r = new Range(0, 3);
            let re;
            assert.doesNotThrow(() => re = r.subRange(new Range(0, 3)));
            assert(re.length === 0);
        });
        it('[sub] range [0, 3] sub range [2, 3], should get range [[0, 1]]', () => {
            const r = new Range(0, 3);
            let re;
            assert.doesNotThrow(() => re = r.subRange(new Range(2, 3)));
            assert(re[0].head === 0);
            assert(re[0].tail === 1);
        });
        it('[sub] range [0, 3] sub range [2, 4], should get range [[0, 1]]', () => {
            const r = new Range(0, 3);
            let re;
            assert.doesNotThrow(() => re = r.subRange(new Range(2, 4)));
            assert(re[0].head === 0);
            assert(re[0].tail === 1);
        });
        it('[sub] range [0, 3] sub range [1, 2], should get range [[0, 0], [3, 3]]', () => {
            const r = new Range(0, 3);
            let re;
            assert.doesNotThrow(() => re = r.subRange(new Range(1, 2)));
            assert(re[0].head === 0);
            assert(re[0].tail === 0);
            assert(re[1].head === 3);
            assert(re[1].tail === 3);
